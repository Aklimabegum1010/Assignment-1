      ...
      <div>
        <div data-theme='light' className='w-full'>
          ...
          <div className='w-5/6 ml-28 rounded-3xl'>
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co/pQtfmsb/5e835be22500005c000585d5.webp)' }}>
              <div className="hero-overlay bg-opacity-60"></div>
              <div className="hero-content text-center text-neutral-content">
                <div>
                  <h1 className="mb-5 text-5xl font-bold">Discover an exceptional cooking <br />class tailored for you!</h1>
                  <p className="mb-5">Learn and Master Basic Programming, Data Structures, Algorithem, OOP, Database and solv 500+ coding <br /> problems to become an exceptionally well world-class Programmer.</p>
                  <div className='gap-5 flex ml-56 '>
                  <div>
                  <button className="btn btn-success">Explore Now</button>
                  </div>
                  <div>
                  <button className="btn transparent">Our Feedback</button>
                  </div>
                  </div>
                </div>
              </div>
